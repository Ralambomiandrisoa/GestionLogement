...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <form method="POST" action="<?= site_url('/ajoute') ?>">
        <fieldset>
...
<?php if(!empty(session()->getFlashdata('fail'))) : ?>
 ...
 <?php endif ?>
                    ...
                    <input name="nomag" type="text" class="form-control"  value="<?= isset($agence) ? $agence["nomag"] : ""; ?>">
            <span class="text-danger"><?= isset($validation) ? display_error($validation,'nomag') : '' ?></span>
                </div>
                <div class="mb-3">
                    <label class="form-label">Adresse</label>
                    <input name="adresseag" type="text" class="form-control"   value="<?= isset($agence) ? $agence["adresseag"] : ""; ?>">
               <span class="text-danger"><?= isset($validation) ? display_error($validation,'adresseag') : '' ?></span>
                </div>

                <div class="mb-3">
                    <label class="form-label">Telephone</label>
                    <input name="telag" type="text" class="form-control"   value="<?= isset($agence) ? $agence["telag"] : ""; ?>">
                <span class="text-danger"><?= isset($validation) ? display_error($validation,'telag') : '' ?></span>
                </div>
               ...
               <div align='center'>
                ...
                <a href="<?=base_url('/ajouter_agence')?>" class="btn btn-primary"> Actualiser </a>
                <a href="<?=base_url('/liste_agence')?>" class="btn btn-primary"> Liste Agence </a>
               </div>
            </fieldset>
        </form>
                        </div>
