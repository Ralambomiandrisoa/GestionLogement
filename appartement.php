        ...
        <div class="header-advance-area">
            ...
            <div class="col-md-9 col-md-9 col-sm-9 col-xs-12">
                        <div class="hpanel email-compose mg-b-15">
                            ...
                            <?php if (isset($appartement)) : ?>
            <div class="alert alert-danger">
                <?= $message ?>
            </div>
        <?php endif ?>

        <form method="POST" action="<?= site_url('/ajout') ?>">
        <fieldset>
...
<?php if(!empty(session()->getFlashdata('fail'))) : ?>
 ...
 <?php endif ?>
                    ...
                    <input name="nomapp" type="text" class="form-control"  value="<?= isset($appartement) ? $appartement["nomapp"] : ""; ?>">
            <span class="text-danger"><?= isset($validation) ? display_error($validation,'nomapp') : '' ?></span>
                </div>
                <div class="mb-3">
                    <label class="form-label">Pays</label>
                    <input name="pays" type="text" class="form-control"   value="<?= isset($appartement) ? $appartement["pays"] : ""; ?>">
               <span class="text-danger"><?= isset($validation) ? display_error($validation,'pays') : '' ?></span>
                </div>

                <div class="mb-3">
                    <label class="form-label">Adresse</label>
                    <input name="adresseapp" type="text" class="form-control"   value="<?= isset($appartement) ? $appartement["adresseapp"] : ""; ?>">
                <span class="text-danger"><?= isset($validation) ? display_error($validation,'adresseapp') : '' ?></span>
                </div>
                <div class="mb-3">
                    <label class="form-label">NombrePiece</label>
                    <input name="nbpiece" type="text" class="form-control"   value="<?= isset($appartement) ? $appartement["nbpiece"] : ""; ?>">
                <span class="text-danger"><?= isset($validation) ? display_error($validation,'nbpiece') : '' ?></span>
                </div>
                <div class="mb-3">
                    <label class="form-label">Prix</label>
                    <input name="prix" type="text" class="form-control"   value="<?= isset($appartement) ? $appartement["prix"] : ""; ?>">
               ...
               <div align='center'>
                ...
                <a href="<?=base_url('/ajouter_appartement')?>" class="btn btn-primary"> Actualiser </a>
