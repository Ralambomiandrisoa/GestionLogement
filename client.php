...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <form method="POST" action="<?= site_url('/ajouter') ?>">
        <fieldset>
...
<?php if(!empty(session()->getFlashdata('fail'))) : ?>
 ...
 <?php endif ?>
                    ...
                    <input name="nomcli" type="text" class="form-control"  value="<?= isset($client) ? $client["nomcli"] : ""; ?>">
            <span class="text-danger"><?= isset($validation) ? display_error($validation,'nomcli') : '' ?></span>
                </div>
                <div class="mb-3">
                    <label class="form-label">Prenom</label>
                    <input name="prenomcli" type="text" class="form-control"   value="<?= isset($client) ? $client["prenomcli"] : ""; ?>">
               <span class="text-danger"><?= isset($validation) ? display_error($validation,'prenomcli') : '' ?></span>
                </div>
                <div class="mb-3">
                <label class="form-label">Sexe</label>
                      <select class="form-control" class="select2 form-select shadow-none select2-hidden-accessible" name='sexe'  style="width: 100%; height: 36px" data-select2-id="1" tabindex="-1" aria-hidden="true">
              ...
              <span class="text-danger"><?= isset($validation) ? display_error($validation,'sexe') : '' ?></span>   
                ...
                <div class="mb-3">
                    ...
                    <input name="cincli" type="number" class="form-control" max_length="12"  value="<?= isset($client) ? $client["cincli"] : ""; ?>">
               <span class="text-danger"><?= isset($validation) ? display_error($validation,'cincli') : '' ?></span>
                </div>
                <div class="mb-3">
                    <label class="form-label">Adresse</label>
                    <input name="adressecli" type="text" class="form-control"   value="<?= isset($client) ? $client["adressecli"] : ""; ?>">
               <span class="text-danger"><?= isset($validation) ? display_error($validation,'adressecli') : '' ?></span>
                </div>
                
                <div class="mb-3">
                    <label class=" form-label"> Telephone</label>
                    <input name="telcli" type="number" class="form-control"  value="<?= isset($client) ? $client["telcli"] : ""; ?>">
               <span class="text-danger"><?= isset($validation) ? display_error($validation,'telcli') : '' ?></span>
                </div>
                <br>
                
               <div align='center'>
                <button type="submit" class="btn btn-primary">Enrgistrer</button>
                <a href="<?=base_url('/ajouter_client')?>" class="btn btn-primary"> Actualiser </a>
