...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <br>
            <div align='center'>  <h1>LISTE DES AGENCES</h1> </div>
            <br>
...
<?php if (isset($liste) && count($liste)) : ?>
            <table class="table table-bordered table-striped">
                ...
                <td >
                <a href="<?=base_url('modifi/'.$agence['numag'])?>">
                <i class="fa fa-pencil-square-o" data-toggle="tooltip" title="Edit" class="pd-setting-ed">
                </i>    
                </a>

                <a action="<?=base_url('delet/'.$agence['numag'])?>" method="POST" >
