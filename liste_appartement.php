...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <br>
            <div align='center'>  <h1>LISTE APPARTEMENT</h1> </div>
            <br>

<div class="card card-table flex-fill">
<div class="card-body">
<div class="table-responsive">
<?php if (isset($liste) && count($liste)) : ?>
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php foreach ($liste as $appartement) : ?>
                        <tr>
                            <td><?= $appartement['nomapp'] ?></td>
                            <td><?= $appartement['pays'] ?></td>
                            <td><?= $appartement['adresseapp'] ?></td>
                            <td><?= $appartement['nbpiece'] ?></td>
                            <td><?= $appartement['prix'] ?></td>
                            <td class="text-end">
                                <a href="<?=base_url('modif/'.$appartement['numapp'])?>"><i class="btn btn-primary rounded-pill">
                                    <i class="fe fe-pencil"></i>
                                    <div class="actions">
                                </a>
                                <form action="<?=base_url('supp/'.$appartement['numapp'])?>" method="POST" ><input type="hidden" name="_method" value="delete"><button class="btn btn-sm bg-danger-light" onclick="return confirm('Voulez vous vraiment supprimer cette appartement ?')"> <i class="fe fe-trash"></i></button></form>
        ...
        <?php else : ?>
            <div class="alert alert-danger">
                Aucune appartement enregistrée
            </div>
        <?php endif ?>
</div>
