...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <br>
            <div align='center'>  <h1>LISTE CLIENT</h1> </div>
            <br>
                    ...
                    <?php foreach ($liste as $client) : ?>
                        <tr>
                            ...
                            <td><?= $client['adressecli'] ?></td>
                                ...
                                <td>
                                 <a href="<?=base_url('modifier/'.$client['numcli'])?>" data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                 <a action="<?=base_url('delete/'.$client['numcli'])?>" method="POST" >
                <input type="hidden" name="_method" value="delete">
                <button class="btn btn-sm bg-danger-light" onclick="return confirm('Voulez vous vraiment supprimer cette appartement ?')">
