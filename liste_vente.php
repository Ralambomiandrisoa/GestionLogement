...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <br>
            <div align='center'>  <h1>LISTE VENTE</h1> </div>
            <br>
                ...
                <tbody>
                    <?php foreach ($liste as $vente) : ?>
                        <tr>
                            ...
                            <td><?= $vente['prix'] ?></td>
                            <td class="text-end">
                                <a href="<?=base_url('mod/'.$vente['numvente'])?>"><i class="btn btn-primary rounded-pill">
                                    <i class="fe fe-pencil"></i>
                                    <div class="actions">
                                </a>
                                <form action="<?=base_url('de/'.$vente['numvente'])?>" method="POST" ><input type="hidden" name="_method" value="delete"><button class="btn btn-sm bg-danger-light" onclick="return confirm('Voulez vous vraiment supprimer cette vente ?')"> <i class="fe fe-trash"></i></button></form>
