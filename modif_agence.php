...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <br>
           <div class="container">
      <center>   <h1>Modifier Agence</h1> </center>
        <form method="POST" action="<?= site_url('/logement/modifi/'.$agence['numag']) ?>">
            ...
            <div class="col-sm-6">
                ...
                <label class="form-label">Nom</label>
                  ...
                  <div class="mb-3">
                    ...
                    <input name="adresseag"
                     id="adresseag" 
                     required="adresseag"
                      type="text" class="form-control" 
                      placeholder="Adresse Agence"
                       value="<?=$agence['adresseag'] ?>">        
                        </div>

                <div class="mb-3">
                <label class="form-label">Telephone</label>
                    <input name="telag" id="telag" 
                    required="telag" type="text" 
